...
const SingleListItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group rounded-lg bg-white shadow-1 border border-[#EDE4D8]/60">
      <div className="flex">
        <div className="shadow-list relative overflow-hidden flex items-center justify-center max-w-[270px] w-full sm:min-h-[270px] p-4 border-r border-[#EDE4D8]/60">
        ...
        <div className="w-full flex flex-col gap-5 sm:flex-row sm:items-center justify-center sm:justify-between py-5 px-4 sm:px-7.5 lg:pl-11 lg:pr-12">
          <div>
            ...
            <span className="flex items-center gap-2 font-medium text-lg">
              <span className="text-dark">{formatPkr(item.discountedPrice)}</span>
              <span className="text-dark-4 line-through">{formatPkr(item.price)}</span>
            </span>
          </div>
