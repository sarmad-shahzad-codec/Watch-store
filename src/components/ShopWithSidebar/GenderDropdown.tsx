...
const GenderDropdown = ({ genders }) => {
  ...
  return (
    <div className="bg-white shadow-1 rounded-lg">
      ...
      >
        <p className="text-dark">Who it&apos;s for</p>
        <button
          onClick={() => setToggleDropdown(!toggleDropdown)}
      ...
      >
        <p className="-mt-1 text-[11px] leading-relaxed text-dark-4">
          Sport chronographs (TAG Heuer, Hublot) and Oyster-style pieces (Rolex)
          usually skew larger on the wrist; dress references from Patek or Tissot
          often wear lighter — use case size above as a first filter.
        </p>
