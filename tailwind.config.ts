...
const config: Config = {
  ...
  theme: {
    ...
    colors: {
      ...
      blue: {
        DEFAULT: "#4A2F19", // primary dark oaky
        dark: "#3A2413", // darker oaky
        light: "#8B5A2B", // lighter warm wood
        "light-2": "#B27A3A",
        "light-3": "#D19A59",
        "light-4": "#E6C095",
        "light-5": "#F3E3D0",
    ...
    extend: {
      ...
      animation: {
        "social-proof-progress":
          "socialProofProgress 2s linear forwards",
      },
    },
  },
  plugins: [],
